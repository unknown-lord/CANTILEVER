...
root.config(bg = '#0e1c1c')
root.title('Personal Contact Book - By Priyanshu Raj')
root.resizable(0,0)
contactlist = [
    ['Shivam Nigam','369858712'],
    ['Varun Patil', '521159022'],
    ['Abhishek Nikam', '78945614'],
    ['Sakshi Bansal', '58745246'],
    ['Mohit Paul', '5846975'],
    ['Karan Patel', '5647892'],
    ['Sam Sharma', '89685320'],
...
select = Listbox(frame, yscrollcommand=scroll.set,font=('Courier New',14),bg="#f0fffc",width=20,height=20,borderwidth=3,relief="groove")
